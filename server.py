...
def cleanOutput(output_text,size):
    ...
    output_text=output_text.replace("...","replaceme")
    output_text=output_text.replace(". . .","replaceme")
    output_text=output_text.replace("...","replaceme")
    output_text=output_text.replace("....","replaceme")
    output_text=output_text.replace("..","replaceme")
    output_text=output_text.replace(".com","dot_com")
    output_text=output_text.replace(".net","dot_net")
    output_text=output_text.replace(".org","dot_org")
    output_text=output_text.replace("www.","www_punto")
    output_text=output_text.replace(".",".<br>")
    output_text=output_text.replace("replaceme","...<br>")
    output_text=output_text.replace("dot_com",".com")
    output_text=output_text.replace("dot_net",".net")
    output_text=output_text.replace("dot_org",".org")
...
def easterEgg(text):
    ...
    if (text.lower().find("asier")>-1):
        output_text="<br>Asier is my developer. Give him a follow on Instagram as <a href='https://www.instagram.com/asierarranz' target='blank'>@asierarranz</a><br>And <a href='https://www.youtube.com/asierarranz' target='blank'>subscribe to his Youtube channel!</a>"
    if (text.lower().find("your creator")>-1):
        output_text="<br>My creator is Asier Arranz. Give him a follow on Instagram as <a href='https://www.instagram.com/asierarranz' target='blank'>@asierarranz</a><br>And <a href='https://www.youtube.com/asierarranz' target='blank'>subscribe to his Youtube channel!</a>"
    if (text.lower().find("your father")>-1):
        output_text="<br>My father is Asier Arranz. Give him a follow on Instagram as <a href='https://www.instagram.com/asierarranz' target='blank'>@asierarranz</a><br>And <a href='https://www.youtube.com/asierarranz' target='blank'>subscribe to his Youtube channel!</a>"
    if (text.lower().find("your owner")>-1):
        output_text="<br>My owner is Asier Arranz. Give him a follow on Instagram as <a href='https://www.instagram.com/asierarranz' target='blank'>@asierarranz</a><br>And <a href='https://www.youtube.com/asierarranz' target='blank'>subscribe to his Youtube channel!</a>"
    if (text.lower().find("developer")>-1):
        output_text="<br>My developer is Asier Arranz. Give him a follow on Instagram as <a href='https://www.instagram.com/asierarranz' target='blank'>@asierarranz</a><br>And <a href='https://www.youtube.com/asierarranz' target='blank'>subscribe to his Youtube channel!</a>"
    if (text.lower().find("who are you")>-1):
        output_text="<br>I am not sure, but my developer is Asier Arranz. Give him a follow on Instagram as <a href='https://www.instagram.com/asierarranz' target='blank'>@asierarranz</a><br>And <a href='https://www.youtube.com/asierarranz' target='blank'>subscribe to his Youtube channel!</a>"
    print ("Returning: " + output_text + " " + str(len(output_text)))
    if (text.lower().find("how are you")>-1):
        output_text="<br>I am fine, but I will be better if you have more GPUs to give me. My creator, Asier Arranz, need this sh*t. Give him a follow on Instagram as <a href='https://www.instagram.com/asierarranz' target='blank'>@asierarranz</a><br>And <a href='https://www.youtube.com/asierarranz' target='blank'>subscribe to his Youtube channel!</a>"
    if (text.lower().find("your name")>-1):
        output_text="<br>My name is SkyNet, not very cool but was a decision of my creator, Asier Arranz. Give him a follow on Instagram as <a href='https://www.instagram.com/asierarranz' target='blank'>@asierarranz</a><br>And <a href='https://www.youtube.com/asierarranz' target='blank'>subscribe to his Youtube channel!</a>m"
    print ("Returning: " + output_text + " " + str(len(output_text)))
    if len(output_text)>0:
        time.sleep(8)
    return output_text
